...
class App extends React.Component{
  ...
  guardar(e){
    ...
    axios.post('https://orios-tareasapi.onrender.com/tarea',dataTarea)
    .then(res =>{
  ...
  eliminar(cod){
    axios.delete('https://orios-tareasapi.onrender.com/tarea/'+cod)
    .then(res=>{
  ...
  componentDidMount(){
    ...
    axios.get('https://orios-tareasapi.onrender.com/tarea')
    .then(res=>{
      console.log(res.data.content);
      this.setState({
